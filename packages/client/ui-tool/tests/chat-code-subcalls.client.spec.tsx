...
import { en as conversationEn, hi as conversationHi, NS as CONVERSATION_NS } from '@deepseek-ai/dsh-client-ui-conversation/src/client/locales.ts'
...
async function bench(snapshot: ChatSnapshot) {
  ...
  locale.register(CONVERSATION_NS, { en: conversationEn, hi: conversationHi })
