...
import { en, hi, te, type AgentPresetSettingsKey } from './locales.ts'
...
export function apply(ctx: ClientContext): void {
  ...
  ctx.effect(() => ctx.locale.register('settings.agentPreset', { en, hi, te }), 'ui-agent-preset: settings row dictionaries')
