...
export type PixelAgentInput = {
  ...
  standup: boolean
  /** Hyperion workflow plan for the thinking bubble (null when no plan). */
  plan: { lines: string[]; current: number } | null
  /** Skill currently being read at the Skill Catalogue (null when none). */
  skill: string | null
}
