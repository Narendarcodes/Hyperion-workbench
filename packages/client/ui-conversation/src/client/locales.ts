...
export const en = {
  ...
  'voice.record': 'Record voice prompt',
  'voice.stop': 'Stop recording',
  'voice.recording': 'Recording audio... Click to stop and transcribe',
  'voice.transcribing': 'Transcribing with IndicConformer...',
  'voice.idle': 'Voice prompt (IndicConformer ASR)',
  'voice.waveform': 'Voice input level',
  'voice.discard': 'Discard recording',
  'voice.recordingNow': 'Recording voice message',
  'voice.elapsed': 'Recording time {time}',
